...
public class HomeController : Controller
    ...
    public ActionResult EmployeeList_Read([DataSourceRequest]DataSourceRequest request)
    {
        var employee = db.Employees.OrderBy(e => e.FirstName);
        return Json(Employee.ToDataSourceResult(request, ModelState), JsonRequestBehavior.AllowGet);
    }
